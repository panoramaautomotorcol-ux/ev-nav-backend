...
const VEHICLE_PROFILES = {
  ...
  'chevrolet_bolt_euv_65': { batteryKwh: 65.0, consumptionRate: 0.24 },
  ...
  'zeekr_x_sport_51': { batteryKwh: 51.0, consumptionRate: 0.3 },
  'zeekr_1_flagship_100': { batteryKwh: 100.0, consumptionRate: 0.17 },
  'zeekr_7x_flagship_awd_100': { batteryKwh: 100.0, consumptionRate: 0.18 },
  'zeekr_7x_premium_rwd_100': { batteryKwh: 100.0, consumptionRate: 0.16 },
  'zeekr_7x_sport_75': { batteryKwh: 75.0, consumptionRate: 0.21 },
  'zeekr_1_sport_100': { batteryKwh: 100.0, consumptionRate: 0.16 },
  ...
  // 🆕 Sincronizados desde la app (antes caian al generico)
  'chery_e5_51': { batteryKwh: 50.6, consumptionRate: 0.24 },
  'mini_aceman_e_39': { batteryKwh: 39.0, consumptionRate: 0.35 },
  'mini_jcw_aceman_e_49': { batteryKwh: 49.0, consumptionRate: 0.3 },
  'dongfeng_box_e2_44': { batteryKwh: 44.0, consumptionRate: 0.35 },
  'dongfeng_box_e3_44': { batteryKwh: 44.0, consumptionRate: 0.35 },
  'dongfeng_vigo_e2_44': { batteryKwh: 44.94, consumptionRate: 0.3 },
  'dongfeng_vigo_e2_plus_51': { batteryKwh: 51.87, consumptionRate: 0.26 },
  'mg_4_urban_comfort_43': { batteryKwh: 43.0, consumptionRate: 0.33 },
  'mg_4_urban_deluxe_43': { batteryKwh: 43.0, consumptionRate: 0.33 },
  'bmw_ix_94': { batteryKwh: 94.8, consumptionRate: 0.18 },
  'byd_dolphin_nuevo_45': { batteryKwh: 45.12, consumptionRate: 0.27 },
  'bestune_xiaoma_13': { batteryKwh: 13.9, consumptionRate: 0.63 },
  'bestune_nat_54': { batteryKwh: 54.0, consumptionRate: 0.25 },
  'bestune_joy_03_49': { batteryKwh: 49.0, consumptionRate: 0.24 },
  'nissan_leaf_40': { batteryKwh: 40.0, consumptionRate: 0.18 },
  'subaru_trailseeker_75': { batteryKwh: 74.7, consumptionRate: 0.19 },
  'chevrolet_captiva_60': { batteryKwh: 60.0, consumptionRate: 0.24 },
  'renault_zoe_41': { batteryKwh: 41.0, consumptionRate: 0.33 },
  'auteco_friday_49': { batteryKwh: 49.27, consumptionRate: 0.24 },
  'mercedes_eqa_250_70': { batteryKwh: 70.0, consumptionRate: 0.2 },
  'mercedes_eqb_250_70': { batteryKwh: 70.0, consumptionRate: 0.21 },
  'mercedes_g580_eq_116': { batteryKwh: 116.0, consumptionRate: 0.22 },
    'bmw_ix3_108': { batteryKwh: 108.7, consumptionRate: 0.14 },
  'kia_ev2_42': { batteryKwh: 42.2, consumptionRate: 0.32 },
  'zeekr_x_premium_69': { batteryKwh: 69.0, consumptionRate: 0.23 },
  'zeekr_x_flagship_66': { batteryKwh: 66.0, consumptionRate: 0.25 },
  'zeekr_001_flagship_94': { batteryKwh: 94.0, consumptionRate: 0.17 },
  'byd_yuan_pro_50': { batteryKwh: 50.0, consumptionRate: 0.31 },
  'opel_crossland_44': { batteryKwh: 44.2, consumptionRate: 0.33 },
  'baic_eu5_48': { batteryKwh: 48.3, consumptionRate: 0.32 },
  'byd_tang_82': { batteryKwh: 82.0, consumptionRate: 0.24 },
  'dongfeng_friday_49': { batteryKwh: 49.27, consumptionRate: 0.31 },
  'mercedes_eqe_350': { batteryKwh: 96.1, consumptionRate: 0.17 },
  'xpeng_g6_air': { batteryKwh: 68.02, consumptionRate: 0.15 },
  'xpeng_g6_pro': { batteryKwh: 80.23, consumptionRate: 0.15 },
  'xpeng_g9': { batteryKwh: 94.6, consumptionRate: 0.18 },
  'gwm_ora5': { batteryKwh: 60.0, consumptionRate: 0.17 },
  'dayun_yuehu_es3_33': { batteryKwh: 33.0, consumptionRate: 0.42 },
...
app.get('/places-fast', async (req, res) => {
  try {
    ...
    if (looksLikeAddress) {
      ...
      // Google Places Text Search (New API) — cobra solo por campos solicitados
...
app.get('/places-google', async (req, res) => {
  try {
    ...
    const items = (r.data.places || []).map(p => ({
...
app.get('/route-alternatives', async (req, res) => {
  try {
    ...
    // Ya no necesitamos forzar tercera alternativa - la ruta EV optimizada
    // se agrega en el frontend como primera opción "Recomendada"
